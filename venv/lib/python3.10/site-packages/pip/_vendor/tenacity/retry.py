...
class _retry_never(retry_base):
    """Retry manager that never rejects any result."""
...
class _retry_always(retry_base):
    """Retry manager that always rejects any result."""
...
class retry_if_exception(retry_base):
    """Retry manager that retries if an exception verifies a predicate."""
