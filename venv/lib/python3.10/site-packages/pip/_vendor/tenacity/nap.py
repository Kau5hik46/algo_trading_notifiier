...
def sleep(seconds: float) -> None:
    """
    Sleep manager that delays execution for a given number of seconds.

    This is the default manager, and may be mocked out for unit testing.
    """
    time.sleep(seconds)


class sleep_using_event:
    """Sleep manager that waits on an event to be set."""
